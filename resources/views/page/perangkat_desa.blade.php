	      ...
	      <div class="card">
	        <div class="card-body">
	          ...
	          <div class="col-md-12 col-sm-12 col-xs-12" align="right" style="margin-bottom: 15px;">
	            <button type="button" class="btn btn-info btn_modal" data-toggle="modal" data-target="#foto"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Data</button>
	          </div>
...
<!-- Modal -->
<form action="{{ url('save_perangkat_desa') }}" method="post" enctype="multipart/form-data" style="width: 100%">
	              ...
	              <tr>
	                <td colspan="2">
	                  ...
	                  <input type="file" class="dropify tes" name="foto" data-max-file-size="3M" data-default-file="" >
	      			  <input type="hidden" value="" name="id" id="id" class="clean">
	                </td>
	              </tr>
	              <tr>
	              	<td>Nama</td>
	              	<td><input type="text" class="form-control nama clean" name="nama" required=""></td>
	              </tr>
	              <tr>
	              	<td>Jabatan</td>
	              	<td><input type="text" class="form-control jabatan clean" name="jabatan" required=""></td>
	              </tr>
	              <tr>
	              	<td>Lain - Lain</td>
	              	<td><input type="text" class="form-control keterangan clean" name="keterangan" required=""></td>
	              </tr>
	            </table>
	        </div>
	      </div>
...
<form action="{{ url('delete_perangkat_desa') }}" method="post" enctype="multipart/form-data" id="delete">
	{{ csrf_field() }}
...
<script type="text/javascript">
	...
	$('.datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url:'{{ route('datatable_perangkat_desa') }}',
