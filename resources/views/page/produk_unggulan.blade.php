      ...
      <div class="col-md-12 row">
        <div class="col-md-12">
          <div class="news-head" style="width: 100%">
            <span class="text-light judul"><b>PRODUK UNGGULAN</b></span>
          </div>
          <div class="col-md-12">
            <h2><b>{{ $potensi->judul }}</b></h2>
            <div class="col-md-12">
                <p class="pull-right"><a  href="#" title="Posts by Anil {{ $potensi->name }}" rel="author">{{ $potensi->name }}</a>&nbsp;•&nbsp; {{ $potensi->tanggal }}</p>
            </div>
          ...
          <div id="fb-root" style="margin-left: 8%">
            <div class="fb-comments" data-href="{{ url('produk_unggulan') }}/{{ $potensi->potensi_id }}" data-numposts="100"></div>
          </div>
        </div>
      </div>
    </div>
