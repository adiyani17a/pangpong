	      ...
	      <div class="card">
	        <div class="card-body">
	          ...
	          <div class="col-md-12 col-sm-12 col-xs-12" align="right" style="margin-bottom: 15px;">
	            <button type="button" class="btn btn-info btn_modal" data-toggle="modal" data-target="#video"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Video</button>
	          </div>
...
<!-- Modal -->
<form action="{{ url('save_video') }}" method="post" enctype="multipart/form-data" style="width: 100%">
	        ...
	        <div class="row">
	            <table class="table ">
	              <tr>
	                <td>
	                  {{ csrf_field() }}
	                  <input type="file" class="dropify tes" name="video" data-max-file-size="32M" data-default-file="" >
...
<div id="preview" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <iframe class="preview" src="" style="width:100%;height: 500px;"></iframe>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" data-dismiss="modal">Close</button>
...
<form action="{{ url('delete_video') }}" method="post" enctype="multipart/form-data" id="delete">
	{{ csrf_field() }}
